...
[
    ...
    { name: "run", labeltext: qsTr("Running"), icon: "../workouticons/running.png" },
    { name: "ride", labeltext: qsTr("Roadbike"), icon: "../workouticons/biking.png" },
    { name: "walk", labeltext: qsTr("Walking"), icon: "../workouticons/walking.png" },
