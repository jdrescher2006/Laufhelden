    ...
    SilicaFlickable
    {
        ...
        Column
        {
            ...
            Label
            {
                ...
                font.pixelSize: Theme.fontSizeExtraSmall
                color: Theme.secondaryColor
                text: qsTr("Spanish") + " - Caballlero<br>" + qsTr("Polish") + " - atlochowski<br>" + qsTr("Swedish") + " - eson57<br>" + qsTr("Finnish") + " - niemisenjussi<br>" + qsTr("Hungarian") + " - martonmiklos" + qsTr("Dutch") + " - d9h20f"
            }            
            Item
            {
                width: parent.width
